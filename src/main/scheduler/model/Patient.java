...
public class Patient {
    ...
    public void removeAvailability(Date d, String c_name) throws SQLException {
        ConnectionManager cm = new ConnectionManager();
        Connection con = cm.createConnection();
    ...
    public void showAppointments() throws SQLException {
        ...
        String showapt = "SELECT id, p_name, c_name, Time,v_name FROM Appointments WHERE p_name = ?;";
        try {
            ...
            if (!resultSet.isBeforeFirst()){
                ...
                while(resultSet.next()){
                    ...
                    System.out.println("Appointment ID: "+aptID+" vaccine name: "+v_name+" date: "+Time+" caregiver name: "+c_name);
                }
            }
        } catch (SQLException e) {
            throw new SQLException();
